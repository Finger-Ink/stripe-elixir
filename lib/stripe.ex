defmodule Stripe do
  ...
  defp get_api_version do
    System.get_env("STRIPE_API_VERSION") || Application.get_env(:stripe, :api_version) || nil
  end

  defp get_api_endpoint do
    System.get_env("STRIPE_API_ENDPOINT") || Application.get_env(:stripe, :api_endpoint) ||
  ...
  defp create_headers(opts) do
    ...
    case get_api_version() do
      nil -> headers
      version_id -> [{"Stripe-Version", version_id} | headers]
    end
  end
